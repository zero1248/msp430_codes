...
#define KEY1_IN  ( P1IN & BIT0 ) //KEY1输入IO的定义(P3.0)
#define KEY2_IN  ( P1IN & BIT1 ) //KEY2输入IO的定义(P3.1)
#define KEY3_IN  ( P1IN & BIT2 ) //KEY3输入IO的定义(P3.2)
#define KEY4_IN  ( P1IN & BIT3 ) //KEY3输入IO的定义(P3.3)
