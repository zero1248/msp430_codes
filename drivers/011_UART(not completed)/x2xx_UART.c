...
static unsigned char Rx_FIFO_DataNum = 0;       //UART接收FIFO“空满”指示
static unsigned char Rx_FIFO_IndexR = 0;        //UART接收FIFO的模拟“读指针”
static unsigned char Rx_FIFO_IndexW = 0;        //UART接收FIFO的模拟“写指针”

unsigned char Tx_FIFO[TX_FIFO_SIZE]={0}; //UART发送FIFO数组
static unsigned char Tx_FIFO_DataNum = 0;       //UART发送FIFO“空满”指示
static unsigned char Tx_FIFO_IndexR = 0;        //UART发送FIFO的模拟“读指针”
static unsigned char Tx_FIFO_IndexW = 0;        //UART发送FIFO的模拟“写指针”
